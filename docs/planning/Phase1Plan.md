...
| Phase 1.15：多语言支持 v1 | 进行中 | 语言数据模型、账号/本地偏好、I18n Provider、静态 dictionary、日期时间/月历 locale formatter、首页和设置页主路径 UI 本地化 | 下一步实现 1.15.2 设置页语言选择落地 |
